// Auto-generated from 00.21-welcome.md
...
const entry: IdEntry = {
  ...
  "noLabel": false,
  "metadata": {
    "createdDate": "2025-03-03T03:19:11.859Z",
    "updatedDate": "2025-03-03T03:19:11.859Z"
  },
  "extensions": {
    "smallBusiness": {
      "freeform": [
        ...
        {
          "header": "Search",
          "content": "Search is in demo mode. Try it out: say you're looking for the ID where you manage `payroll`. Now imagine being able to find _anything_ in your business this quickly.\n\nAnd if you can't find something, just let us know on the forum or Discord. We'll point you in the right direction, and update the system to make sure you find it next time."
        },
        {
        ...
        {
          "header": "When",
          "content": "As you'll see when you're browsing the site, we're still building the system. We are targeting a first release of end-March 2025.\n\nMe and Lucy are working on this 6 days a week. It has our complete focus."
        },
        {
          "header": "Also",
          "content": "As this is a Johnny.Decimal membership, you get **everything else** that we produce.\n\nThat's the [workshop](https://jdcm.al/14.22/), [workbook](https://jdcm.al/14.21/), and [life admin system](https://jdcm.al/14.11/). Lifetime also includes our 14-hour beginner Excel course, [Learn with Lucy](https://learnwithlucy.rocks)."
        },
        {
          "header": "Next",
          "content": "Learn why you [don't need to be scared of those numbers](/00.22)."
        }
      ]
    }
  }
