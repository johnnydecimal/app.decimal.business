// Auto-generated from 12.43-permits-tolls-fees-and-other-running-expenses-(formal).md
import type { IdEntry } from "@data/smallBusinessFlat";
const entry: IdEntry = {
  "number": "12.43",
  "title": "Permits, tolls, fees, & other running expenses (formal)",
  "description": "Anything that says you have permission to go through, or stay in, a certain area, plus daily vehicle running expenses.",
  "type": "id",
  "isPublic": true,
  "isHeader": false,
  "noLabel": false,
