// Auto-generated from 14.43-behavioural-cybersecurity.md
import type { IdEntry } from "@data/smallBusinessFlat";
const entry: IdEntry = {
  "number": "14.43",
  "title": "Behavioural cybersecurity",
  "description": "How the business will behave when interacting with the digital world.",
  "type": "id",
  "isPublic": false,
  "isHeader": false,
  "isHidden": false,
