...
const entry: IdEntry = {
  ...
  "noLabel": false,
  "metadata": {
    "createdDate": "2025-03-02T05:16:37.724Z",
    "updatedDate": "2025-03-02T05:16:37.724Z"
  },
  "extensions": {
    "smallBusiness": {
      ...
      "overview": "This kind of training has an ‘end’. There’s a list of things to tick off and achieve. And what’s mandatory for some staff may not be for others. Everyone might need to show they can lift a box safely, but only the IT person has to have a particular Microsoft certification.\n\nSome mandatory training will need to be maintained or renewed. For example, demonstrating first aid skills periodically to keep a qualification.",
