// Auto-generated from 13.53-non-cash-loan-accounts.md
import type { IdEntry } from "@data/smallBusinessFlat";
const entry: IdEntry = {
  "number": "13.53",
  "title": "Non-cash loan accounts",
  "description": "The place to file processed statements and other formal paperwork for non-cash accounts that you owe money to.",
  "type": "id",
  "isPublic": false,
  "isHeader": false,
  "noLabel": false,
