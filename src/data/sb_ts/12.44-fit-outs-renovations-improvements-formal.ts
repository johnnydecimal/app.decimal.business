// Auto-generated from 12.44-fit-outs-renovations-improvements-formal.md
import type { IdEntry } from "@data/smallBusinessFlat";
const entry: IdEntry = {
  "number": "12.44",
  "title": "Fit-outs, renovations, & improvements (formal)",
