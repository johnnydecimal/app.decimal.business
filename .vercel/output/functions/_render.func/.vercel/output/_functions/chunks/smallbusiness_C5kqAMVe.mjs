import { c as createAstro, a as createComponent, r as renderTemplate, d as renderHead, f as renderSlot } from "./astro/server_3DE6TPSA.mjs";
import "kleur/colors";
import "clsx";
/* empty css                          */
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>${title}</title>${renderHead()}</head> <body> <main> ${renderSlot($$result, $$slots["default"])} </main> </body>`;
}, "/Users/john/dev/decimal.business/memberwww.decimal.business/src/layouts/Layout.astro", void 0);
const smallBusiness = {
  systemId: "J92",
    ...
    "10-19": {
      ...
      categories: {
        "11": {
          ...
          description: "This category is _all about_ the business entity and everyone who keeps it going, including staff, professional bodies, and support services.",
          emoji: "🙋",
          ...
          ids: {
            ...
            "11.11": {
              ...
              description: "Proof of the business’ existence, **trading MODIFIED TEST structure**, `and name` -- where it all begins! ",
              metadata: {
                createdDate: "2024-11-19",
                updatedDate: "2024-11-19"
              },
              extensions: {
                smallBusiness: {
                  examples: "Business entity registrations; trading name registrations; income and sales tax registrations; trademark records for trading names; company director identity applications. -- ",
                  moreInfo: "This ID is about your business being born. Think of it like your birth certificate and proof of name. Deciding on a trading structure and name are the first steps to starting a business. This affects how you will operate and the various obligations you will have, especially government taxes. Whether you want to trade alone under your own name, or as a company with staff and its own name, you will have to complete certain registrations to ‘exist’. The more complicated the structure, the more paperwork there will be. But for many people with simple structures, once you’re set up, this ID should be pretty quiet (apart from ensuring registrations stay active). ",
                  exceptions: "Put product or brand-related patents, trademarks, and copyrights in [[XX.XX]]. ",
                  alsoSee: "",
                  rationale: "This ID is not related to your product or service. You might conduct different types of business under one entity. Hence, we recommend that any trademark records for the business name should go here. And if you have other patents, trademarks, or copyrights, they should live with the things they protect. ",
                  links: ""
                }
              }
            },
            ...
            "11.14": {
              ...
              description: "A place for any other legal matters or ‘serious’ documents related to the business entity that a lawyer may have prepared, were issued by the government, or certified by a public official. ",
              metadata: {
                createdDate: "2024-11-19",
                updatedDate: "2024-11-19"
              },
              extensions: {
                smallBusiness: {
                  examples: "Statutory declarations; affidavits; documents related to proof of ownership; non-disclosure or confidentiality agreements; change of company director paperwork; contracts that don’t fit elsewhere; court appearances. ",
                  moreInfo: "It’s hard to predict what other core documents a business may have around the world. Or any legal matters that may need to be dealt with. But if it’s important and doesn’t fit elsewhere, put it here and note its location in your JDex. ",
            ...
            "11.15": {
              ...
              description: "Whether you sell the business, pass it on to a family member, or close it down, this is a place to work out the details. ",
              metadata: {
                createdDate: "2024-11-19",
                updatedDate: "2024-11-19"
              },
            ...
            "11.21": {
              id: "11.21",
              title: "Business plan",
              description: "The indispensable guide to where you are, where you want to be, and what to do to get there. ",
              metadata: {
                createdDate: "2024-11-19",
                updatedDate: "2024-11-19"
              },
            ...
            "11.22": {
              ...
              extensions: {
                smallBusiness: {
                  ...
                  moreInfo: "This is a place for any insurance that covers the business entity interacting with the world. And overall coverage for staff while they are at work. This is also where to store incident reports that might become part of a claim. For example, if a staff member is injured at work put the details and medical report here. ",
                  exceptions: "Staff medical insurance as part of a salary package goes in [[XX.XX]]. Building (structural and/or contents) or land insurance goes in [[12.12]]. Vehicle insurance goes in [[12.42]]. Financial insurance goes in [[13.XX]]. IT insurance goes in [[14.XX]]. Product insurance goes in [[2X.XX]]. ",
                  alsoSee: "",
            ...
            "11.23": {
              ...
              description: "Awareness of the risks that can affect your business and instructions for what to do if they occur. ",
              metadata: {
                createdDate: "2024-11-19",
                updatedDate: "2024-11-19"
              },
            ...
            "11.24": {
              ...
              description: "A place to record and analyse what’s working, what needs improvement, and ideas for making it happen. ",
              metadata: {
                createdDate: "2024-11-19",
                updatedDate: "2024-11-19"
              },
              extensions: {
                smallBusiness: {
                  examples: "What went well today/this week/this month/this year; ‘lessons learned’ to avoid repeat mistakes; miscellaneous anecdotes from staff meetings; and any other notes, dreams, or ideas related to the business. ",
                  moreInfo: "",
                  exceptions: "",
                  alsoSee: "When it’s time to update [[11.21]], this ID should be a gold mine. ",
                  rationale: "",
                  links: ""
                }
              }
            ...
            "11.30": {
              ...
              isHeader: true,
              emoji: "👍",
              description: "The things we do to be a good business to work in or deal with. ",
              metadata: {
                createdDate: "2024-11-19",
                updatedDate: "2024-11-19"
              },
            ...
            "11.31": {
              ...
              description: "How the business will behave towards staff and expectations for staff behaviour. ",
              metadata: {
                createdDate: "2024-11-19",
                updatedDate: "2024-11-19"
              },
            ...
            "11.32": {
              ...
              description: "How the business will behave towards customers, suppliers, and the wider world. ",
              metadata: {
                createdDate: "2024-11-19",
                updatedDate: "2024-11-19"
              },
              extensions: {
                smallBusiness: {
                  examples: "Customer service policy; refund policy; retail terms and conditions; privacy policy; disclaimers; timely payment process for suppliers; environmental and sustainability policy; equal opportunity employer statement; anti-slavery or land acknowledgement statements. ",
                  moreInfo: "How do you want your business to be perceived by others? This is a place for figuring this out and writing it down. We’re not talking about operations as such, or nice things your business might do for the community. It’s for any official policies or statements, or personal stances on how the business will behave. For instance, on your website you might have administrative policies or social, ethical, or environmental statements. Or maybe you have a policy to use local suppliers and pay their invoices early because you want to support others like you. ",
                  exceptions: "This is not related to front office operations, that’s at [[12.30]]. This is not related to being part of a community, that’s at [[12.50]]. ",
                  alsoSee: "",
                  rationale: "",
                  links: ""
                }
            ...
            "11.41": {
              id: "11.41",
              title: "Hiring",
              description: "Anything to do with finding, choosing, & onboarding new staff. ",
              metadata: {
                createdDate: "2024-11-19",
                updatedDate: "2024-11-19"
              },
              extensions: {
                smallBusiness: {
                  examples: "Recruitment agencies or online employment platforms you use’ role descriptions for job ads; CVs/resumes received; the interview process and questions; candidate shortlists; the onboarding process; information for new employees; a checklist that covers the entire hiring process. ",
                  moreInfo: "",
                  exceptions: "",
                  alsoSee: "[[11.42] for creating a new staff record template when someone is hired. [[14.XX]] for assigning and setting up new devices and accounts. ",
                  rationale: "",
                  links: ""
                }
              }
            ...
            "11.42": {
              ...
              description: "The official staff records that a business must keep for a certain period of time, neatly templated. ",
              metadata: {
                createdDate: "2024-11-19",
                updatedDate: "2024-11-19"
              },
            ...
            "11.44": {
              id: "11.44",
              title: "Farewells",
              description: "Anything to do with ending employment and offboarding staff. ",
              metadata: {
                createdDate: "2024-11-19",
                updatedDate: "2024-11-19"
              },
            ...
            "11.51": {
              ...
              description: "The basic, compulsory training that must be done, including general training common to many workplaces or that is specific to yours. ",
              metadata: {
                createdDate: "2024-11-19",
                updatedDate: "2024-11-19"
              },
              extensions: {
                smallBusiness: {
                  ...
                  rationale: "We’ve called this ‘mandatory’ as it’s the kind of training you tend to be given as a new employee. Or it might be required due to workplace compliance laws. Or it’s related to how you or staff are expected to do their job. Either way, it must be done. ",
                  links: ""
                }
              }
            },
            "11.52": {
              ...
              description: "Extra training to gain or maintain a credential that is nice to have, but not mandatory. ",
              metadata: {
                createdDate: "2024-11-19",
                updatedDate: "2024-11-19"
              },
              extensions: {
                smallBusiness: {
                  examples: "Doing an Excel or Xero course to improve your skills; attending an advanced hairdressing or bar tending course to learn new techniques; completing an MBA or specialist dental qualification; gaining the project management professional (PMP) certification. ",
                  moreInfo: "",
                  exceptions: "",
                  alsoSee: "Consider adding these details to official employee records at [[11.42]]. If you have preferred in-person or online training suppliers, store their details at [[12.0X)]]. If the training is based on any ops manuals in [[12.20]] or [[12.30]], ensure any changes are reflected here. ",
            ...
            "11.53": {
              ...
              description: "A place to record any other general learning that doesn’t fit elsewhere. ",
              metadata: {
                createdDate: "2024-11-19",
                updatedDate: "2024-11-19"
              },
            ...
            "11.60": {
              ...
              isHeader: true,
              emoji: "🤝",
              description: "External people and organisations that you interact with in a business capacity who are not suppliers or customers. ",
              metadata: {
                createdDate: "2024-11-19",
                updatedDate: "2024-11-19"
              },
            ...
            "11.61": {
              ...
              description: "Any kind of industry association, professional body, union, society, or similar group that you deal with. ",
              metadata: {
                createdDate: "2024-11-19",
                updatedDate: "2024-11-19"
              },
            ...
            "11.62": {
              ...
              description: "Where to go for help with running the business or your wellbeing as a business owner. ",
              metadata: {
                createdDate: "2024-11-19",
                updatedDate: "2024-11-19"
              },
              extensions: {
                smallBusiness: {
                  examples: "Government small business or finance websites; helplines; mentors; peers/other business owners; professional bodies; unions; ombudsman and watchdogs; mental health organisations. ",
                  moreInfo: "This might include the contact details of anyone you know personally, or a list of websites that you have used previously or have been recommended. Or perhaps a library of useful downloads that you’ve saved on different topics. ",
                  exceptions: "",
                  alsoSee: "",
                  rationale: "",
                  links: "Advice and wellbeing resources designed for small business: - \n- [Ahead for Business](https://aheadforbusiness.org.au/]\n"
                }
              }
            },
            "11.63": {
